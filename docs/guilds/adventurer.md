...
The adventurer guild package is a skeleton implementation. No guild-specific aliases or strategies are defined — it loads the common bot, action queue, and MIP systems but adds no automation on top.
